...
namespace Umbra.Rendering.ImGui
{
    ...
    public class ImGuiRenderer : IDisposable, IRenderPass
    {
            ...
            ColorSpaceHandling colorSpaceHandling )
        {
            ...
            return File.ReadAllBytes( $"Assets/Shaders/imgui/{resourceName}" );
        }
        ...
        /// </summary>
        public void NewFrame( float deltaSeconds, InputSnapshot snapshot )
        {
        ...
        /// <summary>
        /// Called before we handle the input in <see cref="NewFrame"/>.
